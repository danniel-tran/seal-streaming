...
module sealstreaming::sealstreaming;
...
use sealstreaming::seal_approve_whitelist::{Self, SealApproveWhitelist};

// ========== One-Time Witness for Display ==========
public struct SEALSTREAMING has drop {}
...
fun init(otw: SEALSTREAMING, ctx: &mut tx_context::TxContext) {
    // Create registry
